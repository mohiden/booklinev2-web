                  ...
                  <div className="items">
                    <div className="item-content">
                      <div className="user-profile">
                        ...
                        <img src="/assets/img/90x90.jpg" alt="avatar" />
                        <div className="user-meta-info">
                          <p className="user-name" data-name="Linda Nelson">
                            Linda Nelson
                          </p>
                          <p
                            className="user-work"
                  ...
                  <div className="items">
                    <div className="item-content">
                      <div className="user-profile">
                        ...
                        <img src="/assets/img/90x90.jpg" alt="avatar" />
                        <div className="user-meta-info">
                          <p className="user-name" data-name="Lila Perry">
                            Lila Perry
                          </p>
                          <p
                            className="user-work"
                      ...
                      <div className="user-location">
                        <p className="info-title">Location: </p>
                        <p className="usr-location" data-location="Miami, USA">
                          Miami, USA
                        </p>
                      </div>
                      <div className="user-phone">
                  ...
                  <div className="items">
                    <div className="item-content">
                      <div className="user-profile">
                        ...
                        <img src="/assets/img/90x90.jpg" alt="avatar" />
                        <div className="user-meta-info">
                          <p className="user-name" data-name="Andy King">
                            Andy King
                          </p>
                          <p
                            className="user-work"
                  ...
                  <div className="items">
                    <div className="item-content">
                      <div className="user-profile">
                        ...
                        <img src="/assets/img/90x90.jpg" alt="avatar" />
                        <div className="user-meta-info">
                          <p className="user-name" data-name="Jesse Cory">
                            Jesse Cory
                          </p>
                          <p
                            className="user-work"
                  ...
                  <div className="items">
                    <div className="item-content">
                      <div className="user-profile">
                        ...
                        <img src="/assets/img/90x90.jpg" alt="avatar" />
                        <div className="user-meta-info">
                          <p className="user-name" data-name="Xavier">
                            Xavier
                          </p>
                          <p
                            className="user-work"
                  ...
                  <div className="items">
                    <div className="item-content">
                      <div className="user-profile">
                        ...
                        <img src="/assets/img/90x90.jpg" alt="avatar" />
                        <div className="user-meta-info">
                          <p className="user-name" data-name="Susan">
                            Susan
                          </p>
                          <p
                            className="user-work"
                  ...
                  <div className="items">
                    <div className="item-content">
                      <div className="user-profile">
                        ...
                        <img src="/assets/img/90x90.jpg" alt="avatar" />
                        <div className="user-meta-info">
                          <p className="user-name" data-name="Traci Lopez">
                            Traci Lopez
                          </p>
                          <p
                            className="user-work"
